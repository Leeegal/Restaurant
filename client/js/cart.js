jQuery(document).ready(function($) {
    ...
    function addProduct(proname, proid, price, proimg) {
        ...
        if (quantity == '') {
            ...
            var productAdded = $('<li class="product"><div class="product-details"><p><a href="#0">' + proname + '</a>  <span class="price">￥' + price + '</span>  <label for="cd-product-' + proid + '">件数</label>' + select + '</p><div class="actions"><a href="#0" class="delete-item">删除</a></div></div></li>');
            // <div class="product-image"><a href="#0"></a></div>
